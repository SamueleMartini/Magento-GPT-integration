...
class GenerateCategoryDescriptionById extends Command
{
    ...
    {
        $this->setName('gpt-3:generate:category-description:by-id');
        $this->setDescription('Generate category description with GPT-3 Open AI API, providing category ID and store ID.');
        $this->addOption(
            'category_id',
            'c',
