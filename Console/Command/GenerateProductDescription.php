...
class GenerateProductDescription extends Command
{
    ...
    {
        $this->setName('openai-gpt:generate:product-description:by-name');
        $this->setDescription('Generate product description with OpenAI GPT model language API, providing product name and language.');
        $this->addOption(
            'product_name',
            'p',
